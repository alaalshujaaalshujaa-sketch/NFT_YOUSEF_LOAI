...
def get_public_drop_info(w3: Web3, nft_contract: str) -> dict | None:
...
def get_total_supply(w3: Web3, nft_contract: str) -> int | None:
...
def is_mint_active(w3: Web3, nft_contract: str) -> tuple[bool, int | None]:
